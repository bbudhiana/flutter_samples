...
class SlidableScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SlidablePage(title: "Slideable Sample");
  }
}

class SlidablePage extends StatefulWidget {
  SlidablePage({Key key, this.title}) : super(key: key);
  final String title;
...
class _SlidablePageState extends State<SlidablePage> {
  //siapkan controller buat slidable nya
  SlidableController slidableController;

  //buat contoh list item nya
  ...
  //tampungan nilai untuk animasi dan fabcolor
  Animation<double> _rotationAnimation;
  Color _fabColor = Colors.blue;

  //Check jenis slideAnimation nya
  ...
  //Check apakah slide sedang Open
